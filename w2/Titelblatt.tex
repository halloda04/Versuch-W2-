...
\newcommand{\Versuchnummer}{W02}                           %CHange iiit
\newcommand{\Versuch}{Siedepunkterhöhung}          %Change iiit
\newcommand{\Versuchsdatum}{14.11.2025}              %Change iiit
\newcommand{\Abgabedatum}{23.11.2025}                           %Change iiit
...
\vspace{2cm}
\begin{center}
\includegraphics[width=0.4\textwidth, height = 4cm, scale=5.0]{Bilder/Titelbild-W2.png}   %Bild ändern
\end{center}      
    \vfill
\end{titlepage}
\setcounter{page}{2}
